...
import ee.ioc.cs.jbe.viewer.config.window.*;
...
public class BrowserComponent extends JComponent
     ...
     *
     * @param browserPath the viewer path
     */
    ...
    /**
     * Rebuild tree view, clear history and try to set the same path in the viewer as before.
     *
     * @param categoryName
     */
