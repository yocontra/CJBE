...
package ee.ioc.cs.jbe.viewer.config;

import ee.ioc.cs.jbe.viewer.config.classpath.*;
...
public class BrowserConfig implements ClasspathComponent {
    ...
    /**
     * Add the <tt>rt.jar</tt> archive of the JRE used by the bytecode viewer to the classpath.
     */
