...
package ee.ioc.cs.jbe.viewer;

import ee.ioc.cs.jbe.viewer.codeedit.VerifierDisplay;
import ee.ioc.cs.jbe.viewer.config.BrowserConfig;
import ee.ioc.cs.jbe.viewer.config.classpath.ClasspathArchiveEntry;
import ee.ioc.cs.jbe.viewer.config.classpath.ClasspathBrowser;
import ee.ioc.cs.jbe.viewer.config.classpath.ClasspathSetupDialog;
import ee.ioc.cs.jbe.viewer.config.classpath.FindResult;
import ee.ioc.cs.jbe.viewer.config.window.WindowState;
import ee.ioc.cs.jbe.viewer.detail.attributes.code.CodeEditArea;
import ee.ioc.cs.jbe.viewer.detail.attributes.code.CodeEditPane;
...
/**
 * MDI Frame and entry point for the class file viewer application.
 *
